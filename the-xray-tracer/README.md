...
<strong>Note - The content for this section is taken from the [Serverless Lens Whitepaper](https://d1.awsstatic.com/whitepapers/architecture/AWS-Serverless-Applications-Lens.pdf) with minor tweaks.</strong>
